...
hidden if the `visitor_pattern_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `visitor_pattern_DEVELOPER_MODE` to the configure
...
Runs the executable target `visitor_pattern_exe`.
